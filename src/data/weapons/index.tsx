...
const weapons = { Akuoumaru, AlleyHunter, AmenomaKageuchi, AmosBow, ApprenticesNotes, AquaSimulacra, AquilaFavonia, AThousandFloatingDreams, BeaconOfTheReedSea, BeginnersProtector, BlackcliffAgate, BlackcliffLongsword, BlackcliffPole, BlackcliffSlasher, BlackcliffWarbow, BlackTassel, BloodtaintedGreatsword, CalamityQueller, CinnabarSpindle, CompoundBow, CoolSteel, CrescentPike, DarkIronSword, Deathmatch, DebateClub, DodocoTales, DragonsBane, DragonspineSpear, DullBlade, ElegyForTheEnd, EmeraldOrb, EndOfTheLine, EngulfingLightning, EverlastingMoonglow, EyeOfPerception, FadingTwilight, FavoniusCodex, FavoniusGreatsword, FavoniusLance, FavoniusSword, FavoniusWarbow, FerrousShadow, FesteringDesire, FilletBlade, ForestRegalia, FreedomSworn, Frostbearer, FruitOfFulfillment, HakushinRing, Halberd, Hamayumi, HaranGeppakuFutsu, HarbingerOfDawn, HuntersBow, HuntersPath, IbisPiercer, IronPoint, IronSting, JadefallsSplendor, KagotsurubeIsshin, KagurasVerity, KatsuragikiriNagamasa, KeyOfKhajNisut, KingsSquire, KitainCrossSpear, LightOfFoliarIncision, LionsRoar, LithicBlade, LithicSpear, LostPrayerToTheSacredWinds, LuxuriousSeaLord, MagicGuide, MailedFlower, MakhairaAquamarine, MappaMare, MemoryOfDust, Messenger, MissiveWindspear, MistsplitterReforged, MitternachtsWaltz, Moonpiercer, MouunsMoon, OathswornEye, OldMercsPal, OtherworldlyStory, PocketGrimoire, PolarStar, Predator, PrimordialJadeCutter, PrimordialJadeWingedSpear, PrizedIsshinBlade, PrototypeAmber, PrototypeArchaic, PrototypeCrescent, PrototypeRancour, PrototypeStarglitter, Rainslasher, RavenBow, RecurveBow, RedhornStonethresher, RoyalBow, RoyalGreatsword, RoyalGrimoire, RoyalLongsword, RoyalSpear, Rust, SacrificialBow, SacrificialFragments, SacrificialGreatsword, SacrificialSword, SapwoodBlade, SeasonedHuntersBow, SerpentSpine, SharpshootersOath, SilverSword, SkyriderGreatsword, SkyriderSword, SkywardAtlas, SkywardBlade, SkywardHarp, SkywardPride, SkywardSpine, Slingshot, SnowTombedStarsilver, SolarPearl, SongOfBrokenPines, StaffOfHoma, StaffOfTheScarletSands, SummitShaper, SwordOfDescension, TheAlleyFlash, TheBell, TheBlackSword, TheCatch, TheFlute, TheStringless, TheUnforged, TheViridescentHunt, TheWidsith, ThrillingTalesOfDragonSlayers, ThunderingPulse, ToukabouShigure, TravelersHandySword, TulaytullahsRemembrance, TwinNephrite, VortexVanquisher, WanderingEvenstar, WasterGreatsword, WavebreakersFin, Whiteblind, WhiteIronGreatsword, WhiteTassel, WindblumeOde, WineAndSong, WolfsGravestone, XiphosMoonlight };
