...
import MirrorBreaker from './MirrorBreaker';
...
import PrimordialJadeGreatsword from './PrimordialJadeGreatsword';
import PrimordialJadeRegalia from './PrimordialJadeRegalia';
import PrimordialJadeVista from './PrimordialJadeVista';
...
import TheFlagstaff from './TheFlagstaff';
import TheFlute from './TheFlute';
import TheOtherSide from './TheOtherSide';
...
const weapons = { Akuoumaru, AlleyHunter, AmberBead, AmenomaKageuchi, AmosBow, ApprenticesNotes, AquaSimulacra, AquilaFavonia, BeginnersProtector, BlackcliffAgate, BlackcliffLongsword, BlackcliffPole, BlackcliffSlasher, BlackcliffWarbow, BlackTassel, BloodtaintedGreatsword, CalamityQueller, CinnabarSpindle, CompoundBow, CoolSteel, CrescentPike, DarkIronSword, Deathmatch, DebateClub, Deicide, DodocoTales, DragonsBane, DragonspineSpear, DullBlade, EbonyBow, ElegyForTheEnd, EmeraldOrb, EndOfTheLine, EngulfingLightning, EverlastingMoonglow, EyeOfPerception, FadingTwilight, FavoniusCodex, FavoniusGreatsword, FavoniusLance, FavoniusSword, FavoniusWarbow, FerrousShadow, FesteringDesire, FilletBlade, ForestRegalia, FreedomSworn, Frostbearer, FruitOfFulfillment, HakushinRing, Halberd, Hamayumi, HaranGeppakuFutsu, HarbingerOfDawn, HuntersBow, HuntersPath, IronPoint, IronSting, KagotsurubeIsshin, KagurasVerity, KatsuragikiriNagamasa, KingsSquire, KitainCrossSpear, KunwusWyrmbane, LionsRoar, LithicBlade, LithicSpear, LostBallade, LostPrayerToTheSacredWinds, LuxuriousSeaLord, MagicGuide, MappaMare, MemoryOfDust, Messenger, MirrorBreaker, MistsplitterReforged, MitternachtsWaltz, Moonpiercer, MouunsMoon, OathswornEye, OldMercsPal, OneSide, OtherworldlyStory, PocketGrimoire, PolarStar, Predator, PrimordialJadeCutter, PrimordialJadeGreatsword, PrimordialJadeRegalia, PrimordialJadeVista, PrimordialJadeWingedSpear, PrototypeAmber, PrototypeArchaic, PrototypeCrescent, PrototypeRancour, PrototypeStarglitter, Quartz, Rainslasher, RavenBow, RecurveBow, RedhornStonethresher, RoyalBow, RoyalGreatsword, RoyalGrimoire, RoyalLongsword, RoyalSpear, Rust, SacrificialBow, SacrificialFragments, SacrificialGreatsword, SacrificialSword, SapwoodBlade, SeasonedHuntersBow, SerpentSpine, SharpshootersOath, SilverSword, SkyriderGreatsword, SkyriderSword, SkywardAtlas, SkywardBlade, SkywardHarp, SkywardPride, SkywardSpine, Slingshot, SnowTombedStarsilver, SolarPearl, SongOfBrokenPines, StaffOfHoma, SummitShaper, SwordOfDescension, TheAlleyFlash, TheBell, TheBlackSword, TheCatch, TheFlagstaff, TheFlute, TheOtherSide, TheStringless, TheUnforged, TheViridescentHunt, TheWidsith, ThrillingTalesOfDragonSlayers, ThunderingPulse, TravelersHandySword, TwinNephrite, VortexVanquisher, WasterGreatsword, WavebreakersFin, Whiteblind, WhiteIronGreatsword, WhiteTassel, WindblumeOde, WineAndSong, WolfsGravestone };
